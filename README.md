...
```bash
git clone <https://github.com/your-org/testingosaka-website.git>
cd testingosaka-website
pnpm install
```
...
メインブランチにコードがプッシュされると、連携しているホスティングサービスを通じて自動的に本番環境へデプロイされます。ビルドコマンドを手動で実行する場合は以下のコマンドを使用します。
